...
import subprocess
version = subprocess.Popen([r'python', r'setup.py', r'-V'], cwd=r'..', stdout=subprocess.PIPE).stdout.read()
# The full version, including alpha/beta/rc tags.
release = subprocess.Popen([r'python', r'setup.py', r'-V'], cwd=r'..', stdout=subprocess.PIPE).stdout.read()
